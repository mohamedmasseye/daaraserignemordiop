...
export default function AdminNotifications() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const res = await axios.get('http://https://daara-app.onrender.com/api/notifications', {
  ...
  const handleSend = async (e) => {
      ...
      try {
          const token = localStorage.getItem('token');
          const res = await axios.post('http://https://daara-app.onrender.com/api/notifications', formData, {
              headers: { Authorization: `Bearer ${token}` }
          });
  ...
  const handleDelete = async (id) => {
      ...
      try {
          const token = localStorage.getItem('token');
          await axios.delete(`http://https://daara-app.onrender.com/api/notifications/${id}`, {
              headers: { Authorization: `Bearer ${token}` }
          });
