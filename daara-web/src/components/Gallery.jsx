...
export default function Gallery() {
  ...
  // --- ÉTATS PAGINATION (Conservés à l'identique) ---
  ...
  useEffect(() => {
    const fetchMedia = async () => {
      try {
        // ✅ Passage par API pour injecter le token Vault automatiquement
  ...
  // 2. LOGIQUE DE FILTRAGE & PAGINATION (Conservée à l'identique)
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {/* --- HEADER (Pattern Cubes & Design d'origine) --- */}
